...
{
    /**
     * @var array list of single response format. The key are MIME types (e.g. `application/json`)
     * while the value are the corresponding formats (e.g. `html`, `json`) which must be supported
     * as declared in ['application/json' => \yii\web\Response::FORMAT_JSON].
     *
     * If this property is empty or not set, default response format negotiation will be skipped.
     * 
     * but If this property set then it will check for accpt header for support. If this format supported then
     * it will return this format of content else it will skip.
     * 
     * if browser send accept header *\/* then it will also get processed.
     */
