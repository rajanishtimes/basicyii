...
class HttpDigestAuth extends AuthMethod
{
    ...
    public function authenticate($user, $request, $response)
    {
		...
		$nonAuthenticateSection=array('/venue/viewp','/critic/viewp');

		
		\Yii::trace(print_r( $nonAuthenticateSection,true),__METHOD__);
		
           if(in_array($_SERVER['PATH_INFO'],$nonAuthenticateSection)){
        ...
        \Yii::trace('Digest:'.$_SERVER['PHP_AUTH_DIGEST'],'httpDigestAuth');
        ...
        \Yii::trace('Digest:Data:'.print_r($data,true),'httpDigestAuth');
