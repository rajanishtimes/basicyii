 ...
 *     return [
 *         'basicAuth' => [
 *             'class' => \common\filters\auth\HttpBasicAuth::className(),
 *         ],
 *     ];
 * }
 * ```
 ...
 * @modifier Mithun Mandal <mithun12000@gmail.com>
 * @since 2.0
 */
class HttpBasicAuth extends AuthMethod
{
    ...
    public function authenticate($user, $request, $response)
    {
        ...
        if ($this->auth) {
            ...
            $identity = $user->loginByAccessToken($username, basename(get_class($this)));
            if ($identity === null) {
                $this->handleFailure($response);
            }
            return $identity;
