...
namespace common\filters\asset;
 ...
 * @since 2.0
 */
class AssetProcess extends Model
{
     ...
     */
    public $converters = [        
        'common\filters\asset\converter\KalturaConverter',
        'common\filters\asset\converter\YoutubeConverter',
        'common\filters\asset\converter\GeobeatConverter',
        'common\filters\asset\converter\OtherConverter',
    ];
