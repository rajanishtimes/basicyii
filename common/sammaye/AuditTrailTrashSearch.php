...
/**
 * AuditTrailTrashSearch represents the model behind the search form about `common\sammaye\AuditTrail`.
 */
class AuditTrailTrashSearch extends AuditTrail
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = AuditTrail::find()->where('status=0');
