...
Row::begin();
    Column::begin();
        Box::begin([
            ...
            'headerButton' => Html::a(<?= $generator->generateString('Back to {modelClass}', ['modelClass' => Inflector::camel2words($generator->moduleID)]) ?>, ['<?= $generator->getControllerID()?>/index'], ['class' => 'btn btn-success fa fa-long-arrow-left'])
        ]);
